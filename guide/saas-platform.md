...
| | SDK Integration | SaaS Platform |
|---|---|---|
| **For** | Developers building custom apps | Businesses wanting plug-and-play solution |
| **Approach** | Integrate `@appzgatenz/label-print-topbridge-js` into your web app | Use our hosted platform directly |
| **Effort** | Development required | Zero code, ready to use |
...
### [TopBridge Download](https://service.topsale.co.nz/self-service/download/topbridge)
